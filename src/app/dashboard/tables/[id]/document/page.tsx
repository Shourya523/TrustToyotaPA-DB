                    ...
                    <div id="executive-overview" className="space-y-8 scroll-mt-10">
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                            ...
                            <Button 
                                ...
                                className="no-print gap-2 bg-gradient-to-r from-indigo-600 to-blue-600 hover:from-indigo-700 hover:to-blue-700 text-white font-bold h-9 shadow-md shadow-indigo-500/10 shrink-0 self-start sm:self-center"
                            >
